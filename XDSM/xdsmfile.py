...
x.connect("struct", "perf", r"5:W_\text{wing}")
x.connect("struct", "ineq1", r"7:W_\text{wing}")
x.connect("aero", "perf", r"5:C_L, C_D")
...
x.add_input("mda", r"W_{\text{wing}_{\text{ref}}}")
...
x.add_process(["opt", "mda", "loads", "struct", "mda", "aero", "perf", "opt"])
