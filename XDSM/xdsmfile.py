...
# Top Right
x.connect("opt", "loads", (r"2:b, c_r, c_t, c_k", r"CST"))
x.connect("opt", "struct", (r"3:b, c_r, c_t, c_k", r"CST"))
x.connect("opt", "aero", (r"4:h_\text{cr}, M_\text{cr}", r"b, c_r, c_t, c_k", r"CST"))
x.connect("opt", "obj", r"5:h_\text{cr}, M_\text{cr}")
x.connect("opt", "ineq1", r"7:b, c_r, c_t, c_k")
