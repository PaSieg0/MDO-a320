function [c,ceq] = constraints(x)
    % Extract design variables
        ...
        % Calculate fuel capacity for original design
        W_fuel_orig = performance(b_orig, c_r_orig, c_k_orig, c_t_orig, b_k, spar_locs, tank_limits);
        
        % Set up constraint
        ceq1 = W_fuel - min(W_fuel_max_current, W_fuel_orig);

        % Inequality constraints
        c = c1;
        
        % Equality constraint: fuel weight equals min of capacity and original
        ceq = ceq1;
end
